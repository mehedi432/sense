      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 site-logo">
            <a href="/" class="text-black h2 mb-0 font-weight-bolder">Technoholic</a>
          </div>
        ...
        <div class="row">
          <div class="col-12 text-center">
            <p>
              ...
              Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved | This system is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://github.com/mehedi432" target="_blank" >Mehedi Abdullah</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </p>
          </div>
        </div>
